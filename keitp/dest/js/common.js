(function($) {
    ...
    function setFileUpload() {
        ...
        var fileUploader = $('[data-input-form] .file'),
            limitSize = .2 * 1048576, //200kb
            defaultPhoto = "../img/sample/sample_photo.png";
        ...
        function checkError(error, obj) {
            switch (error) {
                case "size":
                    ...
                    alert("The file size is limited to 200kb or less.\n파일 용량은 200kb 이하만 가능합니다.");
                    break;
                case "file":
                ...
                case "img":
                    ...
                    alert('The upload file extension can only be .jpg, .jpeg, and .png.\n업로드 파일 확장자는 .jpg, .jpeg, .png만 가능합니다.');
                    break;
            };
            obj.val("");
        ...
        fileUploader.on('change', 'input[type="file"]', function() {
            ...
            $(this).siblings('img').attr('src', defaultPhoto).parent().siblings('.dummy').val("");
        });
    };
